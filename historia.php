...
<body>
  <title>Historia de la quimica</title>
</head>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarColor02">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#2-par">Grandes exponentes de la química</a>
        </li>
        <li class="nav-item">
...
<div class="cotainer">
        ...
        <h1 class="text-center mt-3  text-white">Datos relevantes</h1>
        <div class="row mt-5">
            <div class="col-md-5 offset-md-1 btn btn-info disabled p-5 border rounded">
                <h2 class="text-center">Etimología</h2>
                <p class="text-center">
            ...
            <div class="col-md-5 offset-md-1">
                <img class="a" src="./imagenes/historia-1.jpg" style="width: 500px;" class="mt-3  " alt="">
            </div>
        </div>
        <div class="row mt-5">
        ...
        <div class="row mt-5">
            ...
            <h1 class="text-center mt-3  text-white">Historia</h1>
          <div class="row mt-5">
            <div class="col-md-5 offset-md-1 btn btn-info disabled p-5 border rounded">
                <p class="text-center" id="1-par">
            ...
            <div class="col-md-5 offset-md-1">
                <img class="a" src="./imagenes/historia-2.jpg" style="width: 500px;" class="mt-3  " alt="">
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-md-4 offset-md-1">
                <img  src="./imagenes/historia-3.jpg" style="width: 500px;" class="mt-3 " alt="">
            </div>
            <div class="col-md-5 offset-md-1 btn btn-info disabled p-5 border rounded">
                <h2 class="text-center">Química como ciencia</h2>
                <p class="text-center">
            ...
            <div class="row mt-5">
            <div class="col-md-5 offset-md-1 btn btn-info disabled p-5 border rounded">
              <h2 class="text-center">Estructura química</h2>
                <p class="text-center">
        ...
        <div class="row mt-5">
            <div class="col-md-10 offset-md-1 btn btn-info disabled p-5 border rounded">
                <h2 class="text-center">Principios de la química moderna
                </h2>
                <p class="text-center">
        ...
        <div class="row mt-5">
            <div class="col-md-5 offset-md-1 btn btn-info disabled p-5 border rounded">
              <h2 class="text-center">Aportes importantes de cientificos famosos</h2>
            ...
            <div class="col-md-5 offset-md-1">
                <img class="a" src="./imagenes/historia-antonio..jpg" style="width: 500px;" class="mt-3  " alt="">
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-md-4 offset-md-1">
                <img  src="./imagenes/historia-marie.jpg" style="width: 500px;" class="mt-3 " alt="">
            </div>
            <div class="col-md-5 offset-md-1 btn btn-info disabled p-5 border rounded">
                <h2 class="text-center">Químicos relevantes del siglo XX-XXI ganadores del Premio Nobel de Química</h2>
                <p class="text-center">
