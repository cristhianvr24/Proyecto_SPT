...
<body>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="./index.php">Study Periodic Table</a>
    ...
    <div class="collapse navbar-collapse" id="navbarColor02">
      <ul class="navbar-nav me-auto">
        <li class="nav-item">
          <a class="nav-link" href="#1-par">Historia</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#2-par">Estructura</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="./preguntas.php">Jugar</a>
        </li>
      </ul>
    </div>
  </div>
...
<div class="cotainer">
        <div class="row mt-5">
            <div class="col-md-10 offset-md-1 btn btn-info disabled p-5 border rounded">
                <h2 class="text-center">Tabla Periodica</h2>
                <img src="./imagenes/tabla-periodica.png" style="width: 600px; height: 300px;">
                <p class="text-center">
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-5 offset-md-1">
                <img class="a" src="./imagenes/tabla-1.jpg" style="width: 500px;" class="mt-3  " alt="">
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-md-4 offset-md-1">
                <img  src="./imagenes/historia-1.1.png" style="width: 500px;" class="mt-3 " alt="">
            </div>
            <div class="col-md-5 offset-md-1 btn btn-info disabled p-5 border rounded">
                <h2 class="text-center">Noción de elemento y propiedades periódicas</h2>
                <p class="text-center">
        ...
        <div class="row mt-5">
          ...
          <div class="row mt-5">
            <div class="col-md-5 offset-md-1 btn btn-info disabled p-5 border rounded">
                <h2 class="text-center">Los pesos atómicos</h2>
                <p class="text-center">
            ...
            <div class="col-md-5 offset-md-1">
                <img class="a" src="./imagenes/pesoatomico.jpg" style="width: 500px;" class="mt-3  " alt="">
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-md-4 offset-md-1">
                <img  src="./imagenes/tiradas.PNG" style="width: 500px;" class="mt-3 " alt="">
            </div>
            <div class="col-md-5 offset-md-1 btn btn-info disabled p-5 border rounded">
                <h2 class="text-center">Primeros intentos de sistematización</h2>
                <p class="text-center">
            ...
            <div class="row mt-5">
            <div class="col-md-5 offset-md-1 btn btn-info disabled p-5 border rounded">
              <h2 class="text-center">Ley de las octavas de Newlands</h2>
                <p class="text-center">
            ...
            <div class="col-md-5 offset-md-1">
                <img class="a" src="./imagenes/octavas.PNG" style="width: 500px;" class="mt-3  " alt="">
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-md-4 offset-md-1">
                <img  src="./imagenes/1-tabla.jpg" style="width: 500px;" class="mt-3 " alt="">
            </div>
            <div class="col-md-5 offset-md-1 btn btn-info disabled p-5 border rounded">
                <h2 class="text-center">Tabla periódica de Mendeléyev</h2>
                <p class="text-center">
              ...
              <div class="row mt-5">
            <div class="col-md-5 offset-md-1 btn btn-info disabled p-5 border rounded">
              <h2 class="text-center">Segunda tabla periódica de Mendeléyev y desarrollos posteriores</h2>
                <p class="text-center">
        ...
        <div id="2-par" class="row mt-5">
            <div class="col-md-10 offset-md-1 btn btn-info disabled p-5 border rounded">
                <h2 class="text-center">Estructura y organización de la tabla periódica
                </h2>
                <p class="text-center">
        ...
        <div class="row mt-5">
                        ...
                        <tr valign="top">
                            <td>
                                <div style="margin-right: 20px;">
                                    <ul>
                                        <li>
                                            <p>Grupo 1 (IA): metales alcalinos</p>
                                        </li>
                                        <li>
                                            <p>Grupo 2 (IIA): metales alcalinoterrenos</p>
                                        </li>
                                        <li>
                                            <p>Grupo 3 (IIIB): familia del escandio (tierras raras y actínidos)</p>
                                        </li>
                                        <li>
                                            <p>Grupo 4 (IVB): familia del titanio</p>
                                        </li>
                                        <li>
                                            <p>Grupo 5 (VB): familia del vanadio</p>
                                        </li>
                                        <li>
                                            <p>Grupo 3 (VIB): familia del cromo</p>
                                        </li>
                                    </ul>
                                </div>
                            </td>
                            <td>
                                <div style="margin-right: 20px;">
                                    <ul>
                                        <li>
                                            <p>Grupo 7 (VIIA): familia del manganeso</p>
                                        </li>
                                        <li>
                                            <p>Grupo 8 (VIII B): familia del hierro</p>
                                        </li>
                                        <li>
                                            <p>Grupo 9 (VIII B): familia del cobalto</p>
                                        </li>
                                        <li>
                                            <p>Grupo 10 (VIII B): familia del níquel</p>
                                        </li>
                                        <li>
                                            <p>Grupo 11 (I B): familia del cobre</p>
                                        </li>
                                        <li>
                                            <p>Grupo 12 (II B): familia del zinc</p>
                                        </li>
                                    </ul>
                                </div>
                            </td>
                            <td>
                                <div style="margin-right: 20px;">
                                    <ul>
                                        <li>
                                            <p>Grupo 13 (III A): térreos</p>
                                        </li>
                                        <li>
                                            <p>Grupo 14 (IV A): carbonoideos</p>
                                        </li>
                                        <li>
                                            <p>Grupo 15 (V A): nitrogenoideos</p>
                                        </li>
                                        <li>
                                            <p>Grupo 15 (V A): nitrogenoideos</p>
                                        </li>
                                        <li>
                                            <p>Grupo 17 (VII A): halógenos</p>
                                        </li>
                                        <li>
                                            <p>Grupo 18 (VIII A): gases nobles</p>
                                        </li>
                                    </ul>
                                </div>
                            </td>
            ...
            <div class="col-md-5 offset-md-1">
                <img class="a" src="./imagenes/tabla-2.png" style="width: 500px;" class="mt-3  " alt="">
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-md-4 offset-md-1">
                <img  src="./imagenes/periodos-tabla.jpg" style="width: 500px;" class="mt-3 " alt="">
            </div>
            <div class="col-md-5 offset-md-1 btn btn-info disabled p-5 border rounded">
                ...
                <p class="text-center">
                    ...
                    <img src="./imagenes/periodos.PNG" style="width: 300px;" class="mt-3 " alt="">
                    <br>
            ...
            <div class="row mt-5">
            <div class="col-md-5 offset-md-1 btn btn-info disabled p-5 border rounded">
              <h2 class="text-center">Bloques</h2>
                <p class="text-center">
            ...
            <div class="col-md-5 offset-md-1">
                <img class="a" src="./imagenes/bloques.png" style="width: 500px; background-color: white;" class="mt-3  " alt="">
            </div>
        </div>
    </div>
    <div class="row mt-5">
            <div class="col-md-10 offset-md-1 btn btn-info disabled p-5 border rounded">
                <h2 class="text-center">Metales, metaloides y no metales</h2>
                <p class="text-center">
